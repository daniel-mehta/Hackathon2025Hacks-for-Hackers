# -*- coding: utf-8 -*-
"""xP FPL Flask API.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16Hc_FrEVfnSNd7ITtZgjjXgJR5RKHyso
"""
...
# Function to map element_type to position
...
# Apply the function to create a new 'position' column
sorted_players['position'] = sorted_players['element_type'].apply(map_element_type_to_position)


# Calculate price by dividing 'now_cost' by 10
sorted_players['price'] = sorted_players['now_cost'] / 10


# Print the filtered players with expected points, position, and price for the next gameweek
print(f"\nPlayers with Expected Points for Next Gameweek ({next_gameweek}):")
print(sorted_players[['web_name', 'expected_points', 'position', 'price']].to_string())
...
csv_data = sorted_players[['web_name', 'expected_points']]
...
def print_top_players(df):
  """Prints the top 5 players for each position."""
...
# Example usage (assuming 'sorted_players' DataFrame is available):
print_top_players(sorted_players)

def get_top_10_players(df):
    """Gets the top 10 players based on expected points."""
    top_10 = df.sort_values('expected_points', ascending=False).head(10)
    return top_10[['web_name', 'expected_points', 'position', 'price']]
